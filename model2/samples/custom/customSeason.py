...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "mask_rcnn_Season.h5")
...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("custom", 1, "skirt_yaz")
        self.add_class("custom", 2, "bag_yaz")
        self.add_class("custom", 3, "footwear_sonb")
        self.add_class("custom", 4, "top_yaz")
        self.add_class("custom", 5, "bag_4mev")
        self.add_class("custom", 6, "footwear_yaz")
        self.add_class("custom", 7, "footwear_kis")
        self.add_class("custom", 8, "shorts_yaz")
        self.add_class("custom", 9, "skirt_ilkb")
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        # Return mask, and array of
        # class IDs of each instance. Since we have
